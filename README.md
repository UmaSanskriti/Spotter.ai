...
> **Set up before 2026-07-19?** The installed hook lives at `~/.spotter/spotter-hook.sh`
> on your machine, and old copies silently drop every event (stdin race). `git pull` and
> re-run `hooks/install.sh` to get the fixed forwarder.
